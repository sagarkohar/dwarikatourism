...
$mail = new PHPMailer();
$headers = 'From: Perfact Fashion <hpopat251@rku.ac.in>' . "\r\n";
$headers .= 'Reply-To: <hpopat251@rku.ac.in>' . "\r\n";
$headers .= 'X-Mailer: PHP/' . phpversion();
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
$to = "nvvyas2@gmail.com";
$subject = "Order Conformation";
$body = $otp."<h1 background:color red;>Thank For Traveling</h1>";
...
$mail->Username   = "hpopat251@rku.ac.in";  // GMAIL username(from)
$mail->Password   = "hpopat251";            // GMAIL password(from)
$mail->SetFrom('hpopat251@rku.ac.in', 'Perfact Fashion'); //from
